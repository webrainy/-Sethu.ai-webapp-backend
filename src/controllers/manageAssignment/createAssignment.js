  ...
  try {
    ...
    if (exstng_assign == EXISTING_ASSIGNMENT.NO) {
      ...
      for (let i = 0; i < student_id.length; i++) {
        ...
        let message = {
          subject: `Assignment Submission for Sri Sathya Sai Dakshata Program`,

          text: `Dear ${student.name},

As part of the Sri Sathya Sai Dakshata Program, we are assigning you a task to assess your understanding and skills. Please find the details below:
